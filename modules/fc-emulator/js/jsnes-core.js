...
export class JsnesCore extends EmulatorCore {
    ...
    async loadROM(data) {
        ...
        // Try Array of numbers first (most compatible)
        const romArray = Array.from(romBytes);
        console.log('[JsnesCore] Passing Array of', romArray.length, 'bytes');
